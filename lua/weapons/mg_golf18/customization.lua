...
SWEP.Customization = {
    ...
    {"att_stock", "att_vm_pi_golf18skel_stock", "att_vm_pi_golf18_stocklight"},
    ...
    {"att_vm_pi_golf18_slide","att_vm_pi_golf18_slide_long","att_vm_pi_golf18_slide_light", "att_vm_pi_golf18imp_stock"},
